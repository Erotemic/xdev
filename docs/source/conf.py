...
Notes:
    ...
    rm -rf ~/code/xdev/docs/source/auto
    cd ~/code/xdev/docs
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/xdev/advanced/
        ...
        Then go to
            ...
            https://github.com/Erotemic/xdev/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/xdev/versions/
"""
#
...
# html_logo = '.static/xdev.svg'
# html_favicon = '.static/xdev.ico'
...
latex_documents = [
    (master_doc, 'xdev.tex', 'xdev Documentation', 'Jon Crall', 'manual'),
]
...
man_pages = [(master_doc, 'xdev', 'xdev Documentation', [author], 1)]
